                ...
                <div style="margin-top:8.5cm;width:19cm;">
                    <div class="row justify-content-center">
                        <h1 class="w-100 text-center" style="font-size:16px;">Nomor :
                            001/UKT/PPS-SMI/KOWIL-JAKBAR/XII/2023
                        </h1>
                    </div>
                    <div class="row justify-content-center">
                    ...
                    <div class="w-100">
                        <table style="margin-left:100px">
                            <tr>
                                ...
                                <td width="5">:</td>
                                <td width="300" class="font-weight-bold">Achmad Ridwan Sidik</td>
                            </tr>
                            <tr>
                                <td width="200">Tempat/Tanggal Lahir</td>
                                <td width="5">:</td>
                                <td width="300">Tangerang, 21 Juni 1986</td>
                            </tr>
                            <tr>
                                <td width="200">Tingkatan Sabuk</td>
                                <td width="5">:</td>
                                <td width="300">Satria Taruna</td>
                            </tr>
                        </table>
                    </div>
                    <div class="row justify-content-center mt-2">
                        <p class="text-center" style="width: 20cm">
                            ...
                            <span class="font-weight-bold">Satria Utama</span>
                        </p>
                    </div>
